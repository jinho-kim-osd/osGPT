...
async def list_files(agent, project: Project, issue: Issue, dir_path: str = ".") -> AbilityResult:
    """
...
async def write_file(agent, project: Project, issue: Issue, file_path: str, data: str) -> AbilityResult:
    """
    Write data
    """
